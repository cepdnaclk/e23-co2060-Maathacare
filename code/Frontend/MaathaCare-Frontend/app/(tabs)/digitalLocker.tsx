...
export default function DigitalLocker() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>{t("myDigitalLocker")}</Text>
      <Text style={styles.subtitle}>{t("secureStorage")}</Text>
      ...
      >
        {isUploading ? (
          ...
          <Text style={styles.buttonText}>{t("uploadPdf")}</Text>
        )}
      </TouchableOpacity>
        ...
        renderItem={({ item }) => (
          <View style={styles.card}>
            <View style={styles.cardHeader}>
              ...
              <View style={styles.cardInfo}>
                <Text style={styles.fileName}>
                  {decodeURIComponent(item.fileName).replace(/%20/g, " ")}
                </Text>
            ...
            <View style={styles.buttonRow}>
              ...
              >
                <Text style={styles.viewText}>{t("viewPdf")}</Text>
              </TouchableOpacity>
              <TouchableOpacity
...
// Include your exact styles here...
