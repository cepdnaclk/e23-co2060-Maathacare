  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {data ? (
        ...
        <Text style={styles.errorText}>Milestone data for Week {id} not found in database.</Text>
      )}
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  ...
  header: { fontSize: 32, fontWeight: 'bold', color: '#ED70A1', marginBottom: 20 },
  card: { backgroundColor: 'white', borderRadius: 20, padding: 25, elevation: 4 },
  infoRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 15, borderBottomWidth: 1, borderBottomColor: '#F3F4F6', paddingBottom: 10 },
  label: { fontSize: 18, color: '#4B5563', fontWeight: '600' },
  value: { fontSize: 18, color: '#1F2937', fontWeight: 'bold' },
  tipContainer: { marginTop: 20, backgroundColor: '#FFF5F7', padding: 15, borderRadius: 15 },
